			...
			try {
				...
				while (threadRunning) {
					...
					if(messageToSend != null){
						System.out.println("Client Thread " + threadID + " Sent: "
							+ messageToSend + "\n");
					}
			...
			try {
				...
				while (threadRunning) {
					...
					if (clientMessage.equalsIgnoreCase("quit")) {
						...
						messageToSend = String.format("Success rate on this channel is %.3f",
							1.0*clientThread.numRightGuesses/clientThread.numTotalGuesses);
					...
					if(messageToSend != null){
						System.out.println("Manager Thread " + threadID + " Sent: "
							+ messageToSend + "\n");
					}
